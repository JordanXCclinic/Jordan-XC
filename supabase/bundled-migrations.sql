...
-- Generated by scripts/bundle-migrations.sh on 2026-09-20. Do not edit.
-- Paste into the Supabase SQL editor and run once, on a new project.
--
-- Do not edit this file. It is regenerated by `npm run db:bundle` from the
-- numbered files in supabase/migrations/, which are the real source.
